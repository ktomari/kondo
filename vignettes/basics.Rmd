...
# Cleaning Personal Files

By and large, on macOS, we want to look for personal files in the following directories (recursively).

```{r}
c(
  # iCloud
  "~/Library/Mobile\ Documents/com~apple~CloudDocs/",
  # user files (minus Library and Applications)
  "~/Desktop",
  "~/Documents",
  "~/Downloads",
  "~/Pictures",
